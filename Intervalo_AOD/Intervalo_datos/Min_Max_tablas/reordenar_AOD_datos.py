...
for archivo in archivos:
    ...
    # Filtrar solo las filas correspondientes al AOD_moda
    df = df[df['AOD'] == 'AOD_moda']
...
orden_categoria = ['IQCA', 'IQCA_1', 'IQCA_7', 'IQCA_14', 'IQCA_18']
...
ruta_salida = r"C:\Users\gisse\OneDrive\Escritorio\Repositorio\Documentos\Intervalo_AOD\Intervalo_datos\Min_Max_tablas\resultado_matriz.xlsx"
