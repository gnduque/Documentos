...
# Realizar el resample anual (promedio)
annual_data = data.resample('A').mean()

# Guardar el resultado en un nuevo archivo CSV
output_path = r"C:\Users\gisse\OneDrive\Escritorio\Repositorio\Documentos\Intervalo_AOD\recopila_datos\Datos_PM25\PM2.5_Annual_Average.csv"
annual_data.to_csv(output_path)

print(f"Resample anual completado. Archivo guardado en: {output_path}")