...
pivot_df.to_csv(r'C:\Users\gisse\OneDrive\Escritorio\Repositorio\Documentos\Intervalo_AOD\Intervalo_datos_Extremos\matriz_IQCA_Extremos.csv', index=False)
