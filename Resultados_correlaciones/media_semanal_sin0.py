...
for file in files:
    ...
    try:
        ...
        # Resampling semanal con la operación mean
        data_resampled = data.resample('W').agg(operations)

        # Calcular la correlación de Pearson para los datos semanales
...
if correlation_results:
    ...
    output_path = r'C:\Users\gisse\OneDrive\Escritorio\Repositorio\Documentos\Resultados_correlaciones\AOD_Correlations_Mean_Weekly__NoZeroAOD.csv'
