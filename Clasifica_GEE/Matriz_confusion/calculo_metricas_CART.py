...
raster_pred_path = r"C:\Users\gisse\OneDrive\Escritorio\Repositorio\Documentos\Clasifica_GEE\Clasifica_RF_CART_SVM\Raster_Results\LULC_2009_2015_CART_32717.tif"
...
try:
    ...
    # Guardar métricas en CSV
    metrics_csv_path = os.path.join(output_dir, "classification_metrics_CART.csv")
